 ...
 */
[_LOWER] = LAYOUT(
  _______, _______, _______, _______, _______, _______,                   _______, _______, _______, KC_LPRN, KC_RPRN, KC_SPC,
  _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   _______,                   _______, _______, _______, KC_LCBR, KC_RCBR, KC_EQL,
  _______, KC_F5,   KC_F6,   KC_F7,   KC_F8,   _______,                   _______, _______, _______, _______, _______, KC_GT,
  _______, KC_F9,   KC_F10,  KC_F11,  KC_F12,  _______, KC_MPLY, KC_MNXT, KC_PIPE, KC_GRAVE, KC_PLUS, _______, _______, KC_PIPE,
...
[_RAISE] = LAYOUT(
  ...
  _______, _______, _______, _______, _______, _______,                     XXXXXXX, KC_LEFT, KC_DOWN, KC_RGHT,   KC_RGHT, XXXXXXX,
