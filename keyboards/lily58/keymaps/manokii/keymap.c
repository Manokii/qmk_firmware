 ...
 */
 ...
 [_QWERTY] = LAYOUT(
  ...
  KC_LCTRL, KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_LBRC,  KC_RBRC,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  RAISE,
                        KC_LGUI,  KC_LALT,   LOWER,  KC_SPC,   KC_ENT,   KC_BSPC,  KC_LCBR, KC_RCBR
),
/* LOWER
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * |      |      |      |      |      |      |                    |      |      |      |   (  |   )  |      |
 ...
 */
[_LOWER] = LAYOUT(
  _______, _______, _______, _______, _______, _______,                   _______, KC_LPRN, KC_RPRN, KC_LPRN, KC_RPRN, KC_SPC,
  _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   _______,                   _______, KC_GRV, KC_UP, KC_LCBR, KC_RCBR, KC_EQL,
  _______, KC_F5,   KC_F6,   KC_F7,   KC_F8,   _______,                   KC_GRV, KC_LEFT, KC_DOWN, KC_RGHT, _______, KC_GT,
  _______, KC_F9,   KC_F10,  KC_F11,  KC_F12,  _______, KC_MPLY, KC_MNXT, KC_PIPE, KC_GRAVE, KC_PLUS, KC_LBRC, KC_RBRC, KC_PIPE,
