 ...
 */
 ...
 [_QWERTY] = LAYOUT(
  ...
  KC_LCTRL, KC_Z,   KC_X,    KC_C,    KC_V,    KC_B, KC_LBRC,  KC_RBRC,  KC_N,    KC_M,    KC_COMM, KC_DOT,  KC_SLSH,  KC_RSFT,
                      KC_LALT, KC_LGUI,  LOWER, KC_SPC,   KC_ENT,   KC_BSPC,  RAISE, RAISE
),
/* LOWER
 * ,-----------------------------------------.                    ,-----------------------------------------.
 * |      |      |      |      |      |      |                    |      |      |      |      |      |   =  |
 ...
 */
[_LOWER] = LAYOUT(
  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,                   _______, _______, _______, KC_LPRN, KC_RPRN, KC_EQL,
  KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,                  _______, _______, _______, KC_LCBR, KC_RCBR, KC_GT,
